...
<body>
    ...
    <section id="leader">
        ...
        <div class="std" id="std" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
            ...
            <p class="-gray">langaues used:PHP(Larvel),Javascript</p>
        </div>
        ...
        <div class="std" id="std" style="visibility: inherit; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
            ...
            <span class="hb" style="visibility: hidden;">Prashanna</span>
            <span class="is" style="visibility: hidden;">Hegde</span>
            <p class="-purple" style="visibility: hidden;">Frontend Devloper</p>
            <p class="-gray">Frontend Devlopement</p>
            <p class="-gray">langaues used: Html,Css,Javascript</p>
        </div>
